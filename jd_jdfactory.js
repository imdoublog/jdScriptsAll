...
[task_local]
#东东工厂
10 2-23/2 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jdfactory.js, tag=东东工厂, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_factory.png, enabled=true

================Loon==============
[Script]
cron "10 2-23/2 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jdfactory.js,tag=东东工厂

===============Surge=================
东东工厂 = type=cron,cronexp="10 2-23/2 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jdfactory.js

============小火箭=========
东东工厂 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jdfactory.js, cronexpr="10 2-23/2 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东工厂');
...
const inviteCodes = [`T019-akuFnZjjC6_Y2KUyL0CjVWnYaS5kRrbA`, 'T0225KkcRxcf9lHTJxL1wP4JcgCjVWnYaS5kRrbA', 'T014a2TkmI-K9F3eIQCjVWnYaS5kRrbA', 'T0205KkcB0lDkCiQZmiz16xJCjVWnYaS5kRrbA'];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
